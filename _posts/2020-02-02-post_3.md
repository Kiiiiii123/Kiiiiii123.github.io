...
##### • Generate some distribution with a lot of noise - Maybe I can have some way to generate not just the demonstration that cause me to drift but perhaps I can have a distribution over trajectories, a distribution where the user's behaviors perturb by some kind of noise forcing them to correct that noise so if we introduce
<p align="center">
