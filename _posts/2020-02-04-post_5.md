...
#### 2. The function of s1 and a1 Q(s1,a1) is equal to the inner part of the expectation. If we know what that is, then the reinforcement learning objective will actually simplify drastically.
<p align="center">
