...
#### 2. But actually it turns out that it is perfectly allowed to actually use a state dependent baseline. There's whole proof how the baseline is unbiased for the case the baseline depends on state s.
<p align="center">
