...
#### This is a lower variance estimate of option one. But we can apply causility and those distributed stuff to option two and we'll have different discounts fot our grad-log-πs at different time steps. And what that means is that for later time steps the grad-log-π is just multiplied by smaller numbers.
<p align="center">
