...
### (10) Can we do the "max" trick again? Yse.
#### 1. Before, what we did is we took our policy iteration with value function, skipped explictly representing the policy and sticked in a max over a into our value updates. This gave us an algorithm that didn't require explictly keeping track of the policy.
#### 2. Let's go to our Q-function version of policy iteration.
<p align= "center">
